...
const translate = {
    en: {
        ...
        "udemy-sub-descr": "The course started in mid-September. It is not completed yet, as it includes both the JS basics (which were completed by mid-November) and React (currently in the process of getting acquainted) + Redux. The certificate will be added after completing the course.",
    ...
    ru: {
        ...
        "udemy-sub-descr": "Курс был начат с середины сентября. Не пройден полностью, так как в него входит как база JS (что была пройдена к середине ноября), так и React (сейчас в процессе знакомства) + Redux. Сертификат будет добавлен после полного окончания курса.",
    ...
    ua: {
        ...
        "udemy-sub-descr": "Курс розпочався в середині вересня. Він ще не завершений, оскільки включає як базу JS (яка була пройдена до середини листопада), так і React (зараз на етапі знайомства) + Redux. Сертифікат буде додано після завершення курсу.",
